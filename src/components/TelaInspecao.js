                ...
                <div style={styles.secaoSuperior}>
                    <div style={styles.inputGroupInline}>
                        ...
                        <input
                            ...
                            onChange={(e) => setInspecaoAtual({ ...inspecaoAtual, placaCaminhao: e.target.value })}
                    ...
                    <div style={styles.inputGroupBlock}>
                        ...
                        <input
                            ...
                            onChange={(e) => setInspecaoAtual({ ...inspecaoAtual, kmUltimaManutencao: e.target.value })}
                            style={styles.inputInspecao}
                    ...
                    <div style={styles.inputGroupBlock}>
                        ...
                        <input
                            ...
                            onChange={(e) => setInspecaoAtual({ ...inspecaoAtual, tipoMovimentacao: e.target.value })}
                            style={styles.inputInspecao}
                            placeholder="Ouve movimentação de Pneu"
                        />
                    </div>
                ...
                <div style={styles.gridPneus}>
                    ...
                    <div style={styles.colunaPneus}>
                        ...
                        <div style={styles.pneuBox}>
                            ...
                            <button onClick={() => adicionarRecapagem('1B')} style={styles.botaoAcao}>ADD RECAP</button>
                            <button onClick={() => adicionarMovimentacao('1B')} style={styles.botaoAcao}>ADD MOV</button>
                            {inspecaoAtual.pneus['1B'].movimentacoes.map((m, i) => (
                                <div key={i} style={styles.itemAdicionado}>{m}</div>
                            ))}
                        </div>
                    </div>
                    ...
                    <div style={styles.colunaPneus}>
                        <div style={styles.pneuBox}>
                            ...
                            <button onClick={() => adicionarRecapagem('2A')} style={styles.botaoAcao}>ADD RECAP</button>
                            <button onClick={() => adicionarMovimentacao('2A')} style={styles.botaoAcao}>ADD MOV</button>
                        ...
                        <div style={styles.pneuBox}>
                            ...
                            <button onClick={() => adicionarRecapagem('2B')} style={styles.botaoAcao}>ADD RECAP</button>
                            <button onClick={() => adicionarMovimentacao('2B')} style={styles.botaoAcao}>ADD MOV</button>
                        </div>
                    </div>
                    ...
                    <div style={styles.colunaPneus}>
                        <div style={styles.pneuBox}>
                            ...
                            <button onClick={() => adicionarRecapagem('3A')} style={styles.botaoAcao}>ADD RECAP</button>
                            <button onClick={() => adicionarMovimentacao('3A')} style={styles.botaoAcao}>ADD MOV</button>
                        </div>
                        ...
                        <div style={styles.pneuBox}>
                            ...
                            <button onClick={() => adicionarRecapagem('3B')} style={styles.botaoAcao}>ADD RECAP</button>
                            <button onClick={() => adicionarMovimentacao('3B')} style={styles.botaoAcao}>ADD MOV</button>
                        </div>
                    </div>
                    ...
                    <div style={styles.colunaPneus}>
                        <div style={styles.pneuBox}>
                            ...
                            <button onClick={() => adicionarMovimentacao('4A')} style={styles.botaoAcao}>ADD MOV</button>
                            <button onClick={() => adicionarRecapagem('4A')} style={styles.botaoAcao}>ADD RECAP</button>
                        </div>
                        ...
                        <div style={styles.pneuBox}>
                            ...
                            <button onClick={() => adicionarRecapagem('4B')} style={styles.botaoAcao}>ADD RECAP</button>
                            <button onClick={() => adicionarMovimentacao('4B')} style={styles.botaoAcao}>ADD MOV</button>
                        </div>
                    </div>
                </div>
